...
public class EcompArch extends AgArch {
	...
	public void initAg(String agClass, ClassParameters bbPars, String asSrc, Settings stts) throws JasonException {
		...
		// Obtem as configurações do time:
		...
		// Obtem as configurações do agente:
	...
	public void act(ActionExec action, List<ActionExec> feedback) {
		...
		if (action.getActionTerm().getFunctor().equals("moveTo")) {
			String lastActionInCurrentCycle = action.getActionTerm().getTerm(0).toString();
